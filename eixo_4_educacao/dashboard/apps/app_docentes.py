...
content_mensal_matricula_row0 = [
    dbc.CardHeader("Média de Matrícula Último Semestre", className='cards-content-info-header-docentes'),
    dbc.CardBody(
        [
            html.P("2800",className="card-text cards-content-info-body-docentes"),
        ]
    ),
]

content_media_matricula_row0 = [
    dbc.CardHeader("Media Renovação de Matrícula", className='cards-content-info-header-docentes'),
    dbc.CardBody(
        [
            html.P("1600",className="card-text cards-content-info-body-docentes"),
        ]
    ),
]
...
content_evasao_anual_row0 = [
    dbc.CardHeader("Média de Evasão Anual", className='cards-content-info-header-docentes'),
    dbc.CardBody(
        [
            html.P("43%",className="card-text cards-content-info-body-docentes"),
        ]
    ),
]
...
content_ultimo_semestre_row0 = [
    dbc.CardHeader("Média de Evasão Último Semestre", className='cards-content-info-header-docentes'),
    dbc.CardBody(
        [
            html.P("30%",className="card-text cards-content-info-body-docentes"),
        ]
    ),
]
...
content_evasao_curso_row1 = [
    dbc.CardHeader("Média de Evasão Semestral por Curso", className='cards-content-chart-header-docentes'),
    dbc.CardBody(
        [
...
content_evasao_sexo_row1 = [
    ...
    dbc.CardBody(
        [
            dcc.Graph(figure=fig_evasao_sexo, id='slider-graph-docentes',animate=True, style={'backgroundColor':'#1a2d46', 'color':'#fffff'}),
        ]
    ),
]
...
import math
@app.callback(Output('slider-graph-docentes', 'figure'),
            [Input('slider-udpdatemode-docentes', 'value')])
...
@app.callback(
    [Output("progress-docentes", "value"), Output("progress-docentes", "children")],
    [Input("progress-interval-docentes", "n_intervals")],
)
